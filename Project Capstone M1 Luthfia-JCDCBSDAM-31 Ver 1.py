...
ListProduct = {
        ...
        "ID Product" : ["S1", "S2","A1","A2","S1","S2","I1","I2"],
...
while True:
    if MenuInput == 1: #display
        ...
        if IDInput in ListProduct["ID Product"]:
            ...
            indexIDInput=ListID.index(IDInput) #0,
            ListQty=ListProduct["Qty Stock"] #10,10,10,10,10,10,10,10,10,10,
            QtyInput=(input('Masukkan Qty Product yang ingin dikurangi :')) #contoh misal 5
            while QtyInput.isalpha():
                print("Mohon Masukkan Angka Bulat")
                QtyInput=(input('Masukkan Qty Product yang ingin dikurangi :'))
            QtyInput_int=int(QtyInput)
            while QtyInput_int>ListProduct["Qty Stock"][indexIDInput]:
                print(f"Stock Product tinggal {ListProduct["Qty Stock"][indexIDInput]}")
                QtyInput=int(input('Masukkan Qty Product yang ingin dikurangi :'))
            else:
                newQty=ListProduct["Qty Stock"][indexIDInput]-QtyInput_int
                ListProduct["Qty Stock"][indexIDInput]=newQty
        else:
            print()    
